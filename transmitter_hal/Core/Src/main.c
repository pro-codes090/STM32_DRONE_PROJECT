...
uint16_t TxBuffer[(NRF24L01_PAYLOAD_LENGTH / 2)] = {0};
...
int main(void)
{
  ...
  while (1)
  {
	...
	HAL_ADC_Start(&hadc1) ;
	HAL_ADC_PollForConversion(&hadc1, 10);
	throtle = HAL_ADC_GetValue(&hadc1);
	HAL_ADC_Stop(&hadc1) ;
