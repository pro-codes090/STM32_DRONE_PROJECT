...
//#endif /* __GNUC__ */
		...
		#define NRF24L01_GPIO_WritePin(gpiox , gpio_pin , pin_state)           Custom_HAL_GPIO_WritePin((gpiox) , (uint32_t)(gpio_pin) , (pin_state))
	...
	#ifndef NRF24L01_SPI_TransmitReceive
		#define NRF24L01_SPI_TransmitReceive(pTxData, pRxData, Size, Timeout)  Custom_HAL_SPI_TransmitReceive(NRF24L01_SPI, (pTxData), (pRxData), (Size), (Timeout))
		#define NRF24L01_SPI_Transmit(pTxData, Size, Timeout)                  Custom_HAL_SPI_Transmit(NRF24L01_SPI, (pTxData), (Size), (Timeout))
		#define NRF24L01_SPI_Receive(pRxData, Size, Timeout)                   Custom_HAL_SPI_Receive(NRF24L01_SPI, (pRxData), (Size), (Timeout))
	#endif
